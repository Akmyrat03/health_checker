...
// @Tags servers
// @Produce json
// @Success 200 {object} map[string][]HealthStatus
// @Router /api/v0/servers/health [get]
...
// 			err := usecases.CheckServer(ctx, entities.Server{Name: server.Name, Url: server.Url}, cfg.Basic.Timeout, smtpUseCase)
